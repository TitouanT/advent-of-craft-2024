class SantaCommunicator:
    ...
    def compose_message(self, reindeer_name, current_location, numbers_of_days_for_coming_back, number_of_days_before_christmas):
    ...
    def is_overdue(self, reindeer_name, current_location, numbers_of_days_for_coming_back, number_of_days_before_christmas, logger):
